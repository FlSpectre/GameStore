...
app.get("/Action", function(request, response) {
  db.all("SELECT * FROM games WHERE category_name = 'Action' ", function(
    error,
    data
  ) {
    response.send(data);
...
app.get("/Fighting", function(request, response) {
  db.all("SELECT * FROM games WHERE category_name = 'Fighting' ", function(
    error,
    data
  ) {
    response.send(data);
...
app.get("/RPG", function(request, response) {
  db.all("SELECT * FROM games WHERE category_name = 'RPG' ", function(
    error,
    data
  ) {
    response.send(data);
...
app.get("/Arcade", function(request, response) {
  db.all("SELECT * FROM games WHERE category_name = 'Arcade' ", function(
    error,
    data
  ) {
    response.send(data);
...
app.get("/MOBA", function(request, response) {
  db.all("SELECT * FROM games WHERE category_name = 'MOBA' ", function(
    error,
    data
  ) {
    response.send(data);
...
app.get("/MMORPG", function(request, response) {
  db.all("SELECT * FROM games WHERE category_name = 'MMORPG' ", function(
    error,
    data
  ) {
    response.send(data);
...
app.get("/FPS", function(request, response) {
  db.all("SELECT * FROM games WHERE category_name = 'FPS' ", function(
    error,
    data
  ) {
    response.send(data);
